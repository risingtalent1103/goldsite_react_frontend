        ...
        <>
            <div className="container">
                <div className="w-full flex xl:flex-row flex-col justify-between mb-24 mt-[80px]">
                    ...
                    <div className="basis-[49.5%] flex md:flex-row flex-col justify-between xl:mt-0 mt-[150px]">
                        <div className="basis-[49%] flex flex-col gap-12">
                        ...
                        <div className="basis-[49%] md:mt-0 mt-[100px]">
                            <TradingChart/>
                        </div>
                    </div>
                </div>
